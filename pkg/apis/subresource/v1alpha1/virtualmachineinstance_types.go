...
// +resource:path=virtualmachineinstances,strategy=VirtualMachineInstanceStrategy
// +subresource:request=VirtualMachineInstancePoweraction,path=poweraction,kind=VirtualMachineInstancePoweraction
